...
export const dishTypeFilters = [
    ...
    { id: 5, apiParam: "desserts", text: "Desserts" },
    { id: 6, apiParam: "drinks", text: "Drinks" },
    { id: 7, apiParam: "main course", text: "Main Course" },
    { id: 8, apiParam: "salad", text: "Salad" },
    { id: 9, apiParam: "pancake", text: "Pancake" },
    { id: 10, apiParam: "preps", text: "Preps" },
    { id: 11, apiParam: "sandwiches", text: "Sandwiches" },
    { id: 12, apiParam: "side dish", text: "Side Dish" },
    { id: 13, apiParam: "soup", text: "Soup" },
    { id: 14, apiParam: "starter", text: "Starter" },
    { id: 15, apiParam: "sweets", text: "Sweets" },
];
